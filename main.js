...
function addStar() {
  ...
  const material = new THREE.MeshStandardMaterial({ color: 0x03ecfc });
...
const Darmax = document.getElementById("Darmax");
const darmax = document.getElementById("darmax");
...
const DarmaxDiv = document.getElementById("Darmaxdiv");
...
const light1 = new THREE.RectAreaLight(whiteColor, 6, 0.5, 11);
...
function activeicon(n) {
  n.style.outline = "6px solid rgb(0, 247, 255)";
  n.style.borderRadius = "50%";
}
function filteractiveicon(p) {
  p.map((x) => {
    if ((x.style.outline = "6px solid rgb(0, 247, 255)")) {
...
Home.addEventListener("click", function () {
  new TWEEN.Tween(camera.position)
    .to(
      {
        x: 1.8657201411138535,
        y: 1.4935185925537058,
        z: 2.66097357050962,
      },
      1000
    )
  ...
  new TWEEN.Tween(controls.target)
    .to(
      {
        x: -3.7169063104491844,
        y: -0.14855073501722424,
        z: -0.6087966729655833,
      },
      1000
    )
    .easing(TWEEN.Easing.Quadratic.Out)
...
homeicon.addEventListener("click", function () {
  new TWEEN.Tween(camera.position)
    .to(
      { x: 1.8657201411138535, y: 1.4935185925537058, z: 2.66097357050962 },
      1000
    )
    .easing(TWEEN.Easing.Quadratic.Out)
    .start();
...
homeiconmobile.addEventListener("click", function () {
  new TWEEN.Tween(camera.position)
    .to(
      { x: 2.245283037186975, y: 2.651320100700064, z: 2.54536487813899 },
      1000
    )
    .easing(TWEEN.Easing.Quadratic.Out)
    .start();
  ...
  new TWEEN.Tween(controls.target)
    .to(
      { x: -5.153252283464849, y: 0.5745845805548225, z: -5.689631167038444 },
      1000
    )
    .easing(TWEEN.Easing.Quadratic.Out)
    .start();
...
design.addEventListener("click", function () {
  new TWEEN.Tween(camera.position)
    .to(
      {
        x: -0.2902927614590909,
        y: 0.9619112082046571,
        z: -0.37407924668938547,
      },
      1000
    )
    .easing(TWEEN.Easing.Quadratic.Out)
  ...
  new TWEEN.Tween(controls.target)
    .to(
      {
        x: -3.7488991606326936,
        y: -0.019425884611936596,
        z: -0.6641730068910666,
      },
      1000
    )
    .easing(TWEEN.Easing.Quadratic.Out)
...
designiconmobile.addEventListener("click", function () {
  new TWEEN.Tween(camera.position)
    .to(
      {
        x: -0.29653563936200733,
        y: 0.9291892973224034,
        z: -0.28632078167634223,
      },
      1000
    )
    .easing(TWEEN.Easing.Quadratic.Out)
  ...
  new TWEEN.Tween(controls.target)
    .to(
      { x: -2.8228853456474674, y: 1.4256323448827652, z: -2.8122337979797063 },
      1000
    )
    .easing(TWEEN.Easing.Quadratic.Out)
    .start();
...
function CVparent(c) {
  ...
  c.style.textShadow = "0.5px 0.5px 0.5px rgb(0, 247, 255)";
}
const CVarray = [DarmaxDiv, Oneatdiv, BJCSdiv, Dnatadiv, JBBdiv, Interpandiv, KTdiv, Sagawadiv];
const CVparentarr = [Darmax, Oneat, BJCS, Dnata, JBB, Interpan, KT, Sagawa];

Darmax.addEventListener("click", function () {
...
engineering.addEventListener("click", function () {
  new TWEEN.Tween(camera.position)
    .to(
      { x: -0.3770444383937166, y: 1.2798507946275264, z: 0.11017145589707791 },
      1000
    )
    .easing(TWEEN.Easing.Quadratic.Out)
    .start();
  ...
  new TWEEN.Tween(controls.target)
    .to(
      {
        x: -3.6317596060389983,
        y: 1.2749812822443247,
        z: 0.056998958031140634,
      },
      1000
    )
    .easing(TWEEN.Easing.Quadratic.Out)
...
function skillbtnactive(j) {
  ...
  j.style.textShadow = "1px 1px 1px white";
}
...
engineeringiconmobile.addEventListener("click", function () {
  new TWEEN.Tween(camera.position)
    .to(
      {
        x: -0.08003414175494417,
        y: 1.6734134659507176,
        z: -0.17488807271056256,
      },
      1000
    )
    .easing(TWEEN.Easing.Quadratic.Out)
  ...
  new TWEEN.Tween(controls.target)
    .to(
      { x: -3.010387295269596, y: 1.470477769999485, z: -0.2236068605613211 },
      1000
    )
    .easing(TWEEN.Easing.Quadratic.Out)
    .start();
...
function drawChart() {
  ...
  var options = { width: 500, height: 400, backgroundColor: "transparent", // Set font color to white
...
corporate.addEventListener("click", function () {
  new TWEEN.Tween(camera.position)
    .to(
      {
        x: -0.40273215727976264,
        y: 0.8630821307561408,
        z: -0.5543521621716916,
      },
      1000
    )
    .easing(TWEEN.Easing.Quadratic.Out)
  ...
  new TWEEN.Tween(controls.target)
    .to(
      {
        x: -0.44797742114527406,
        y: 0.7697220507622689,
        z: -1.4991421131936602,
      },
      1000
    )
    .easing(TWEEN.Easing.Quadratic.Out)
...
corporateiconmobile.addEventListener("click", function () {
  new TWEEN.Tween(camera.position)
    .to(
      {
        x: -0.24792986761535457,
        y: 1.1128008938846679,
        z: -0.1351727777042857,
      },
      1000
    )
    .easing(TWEEN.Easing.Quadratic.Out)
  ...
  new TWEEN.Tween(controls.target)
    .to(
      { x: -0.15983667397475823, y: 1.145348997595008, z: -3.071446986880469 },
      1000
    )
    .easing(TWEEN.Easing.Quadratic.Out)
    .start();
...
portfolio.addEventListener("click", function () {
  new TWEEN.Tween(camera.position)
    .to(
      { x: -0.23336961201897644, y: 0.6547204944557304, z: 0.0713300436858463 },
      1000
    )
    .easing(TWEEN.Easing.Quadratic.Out)
    .start();
  ...
  new TWEEN.Tween(controls.target)
    .to(
      { x: -0.7429086064943, y: 0.6117055886667023, z: 0.023370974162065156 },
      1000
    )
    .easing(TWEEN.Easing.Quadratic.Out)
    .start();
...
portfolioiconmobile.addEventListener("click", function () {
  new TWEEN.Tween(camera.position)
    .to(
      { x: -0.23686830473012455, y: 0.7047768679681863, z: 0.2761021527418035 },
      1000
    )
    .easing(TWEEN.Easing.Quadratic.Out)
    .start();
  ...
  new TWEEN.Tween(controls.target)
    .to(
      { x: -3.0946029890454256, y: 0.9625790878791635, z: -2.505748961451268 },
      1000
    )
    .easing(TWEEN.Easing.Quadratic.Out)
    .start();
...
contactus.addEventListener("click", function () {
  new TWEEN.Tween(camera.position)
    .to(
      { x: -0.36928712640238687, y: 0.4982440235922387, z: 0.5946230613675185 },
      1000
    )
    .easing(TWEEN.Easing.Quadratic.Out)
    .start();
  ...
  new TWEEN.Tween(controls.target)
    .to(
      {
        x: -0.39382685371321574,
        y: 0.49879123456509883,
        z: 0.6038348267135418,
      },
      1000
    )
    .easing(TWEEN.Easing.Quadratic.Out)
...
contactusiconmobile.addEventListener("click", function () {
  new TWEEN.Tween(camera.position)
    .to(
      { x: -0.40879038009790625, y: 0.5530325128008731, z: 0.5278328019952607 },
      1000
    )
    .easing(TWEEN.Easing.Quadratic.Out)
    .start();
  ...
  new TWEEN.Tween(controls.target)
    .to(
      { x: -4.1844260577815975, y: 0.18960640487674507, z: 0.6923041526045425 },
      1000
    )
    .easing(TWEEN.Easing.Quadratic.Out)
    .start();
...
career.addEventListener("click", function () {
  new TWEEN.Tween(camera.position)
    .to(
      { x: 0.6656646841600906, y: 0.6549583621736152, z: 0.8508129496965244 },
      1000
    )
    .easing(TWEEN.Easing.Quadratic.Out)
    .start();
  ...
  new TWEEN.Tween(controls.target)
    .to(
      {
        x: -1.3192882450818835,
        y: -1.0116399272442167,
        z: -1.1155847519569326,
      },
      1000
    )
    .easing(TWEEN.Easing.Quadratic.Out)
...
careericonmobile.addEventListener("click", function () {
  new TWEEN.Tween(camera.position)
    .to(
      { x: 0.5469893310933359, y: 0.5361876472782612, z: 0.7878330278126424 },
      1000
    )
    .easing(TWEEN.Easing.Quadratic.Out)
    .start();
  ...
  new TWEEN.Tween(controls.target)
    .to(
      { x: 0.5318387932809859, y: 0.8218399497695639, z: -3.631144221788547 },
      1000
    )
    .easing(TWEEN.Easing.Quadratic.Out)
    .start();
